...
system_message = """
    ...
    weekly spending plans based on their total budget and specified spending categories, ensuring they can sustain their 
...
def generate_budget_prompt(budget, arrival_date, departure_date, city, country, categories):
    prompt = f"""
        ...
        Please provide a detailed spending plan broken down into weekly periods, making note of potential student discount programs.
        Avoid any small talk or introductory remarks, and do not include graphs, tables, or special formatting. The response should
        be in plain text and divided into three paragraphs.
